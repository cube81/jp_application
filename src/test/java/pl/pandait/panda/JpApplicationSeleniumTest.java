...
@SpringBootTest(classes = {JpApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
public class JpApplicationSeleniumTest {
    ...
    public void startup() throws InterruptedException, MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://10.200.0.159:4444/wd/hub"), capabilities);
        // Spring musi działać!
        
        driver.get(String.format("http://10.200.0.159:%d/", port));
